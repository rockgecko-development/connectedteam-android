 ...
 */
public class TabLayoutOld extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link TabLayoutOld} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link TabLayoutOld}.
     *
     * @attr android.support.design.R.attr.tabGravity
     * @see #setTabGravity(int)
     * @see #getTabGravity()
    ...
    public TabLayoutOld(Context context) {
        this(context, null);
    }

    public TabLayoutOld(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabLayoutOld(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Returns the current mode used by this {@link TabLayoutOld}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    public static final class Tab {
        ...
        private final TabLayoutOld mParent;

        Tab(TabLayoutOld parent) {
            mParent = parent;
        }
            ...
            if (custom != null) {
                ...
                if (hasText) {
                    if (mTextView == null) {
                        ...
                        mTextView = textView;
                        */
                        TextView textView2 = (TextView)LayoutInflater.from(this.getContext()).inflate(android.support.design.R.layout.layout_tab_text, this, false);
