...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.addView(this.mTabStrip, LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
    ...
    public void updateTabTitles(ViewPager pager){
        if(pager.getAdapter()!=null && getTabCount()==pager.getAdapter().getCount()){
            for(int i=0;i<getTabCount();i++){
                getTabAt(i).setText(pager.getAdapter().getPageTitle(i));
            }
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int idealHeight = this.dpToPx(DEFAULT_HEIGHT) + this.getPaddingTop() + this.getPaddingBottom();
        ...
        defaultTabMaxWidth = this.getMeasuredWidth() - this.dpToPx(TAB_MIN_WIDTH_MARGIN);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        SlidingTabStrip(Context context) {
            ...
            mSelectedIndicatorDrawable = context.getResources().getDrawable(R.drawable.segmented_tab_indicator);
        }
        ...
        private void setIndicatorPosition(int left, int right) {
            if(left != this.mIndicatorLeft || right != this.mIndicatorRight) {
                ...
                mSelectedIndicatorDrawable.setBounds(mIndicatorLeft, 0, mIndicatorRight, getHeight());
        ...
        public void draw(Canvas canvas) {
            ...
            if(this.mIndicatorLeft >= 0 && this.mIndicatorRight > this.mIndicatorLeft) {
                //mSelectedIndicatorDrawable.setState(getChildAt(getSelectedTabPosition()).getDrawableState());
                mSelectedIndicatorDrawable.draw(canvas);
                /*
                canvas.drawRect((float)this.mIndicatorLeft,
                        0f,
                        (float)this.mIndicatorRight,
                        (float)this.getHeight(),
                        this.mSelectedIndicatorPaint);
                        */
            }
            super.draw(canvas);
        }
       ...
       // static final int DEFAULT_TEXT_LAYOUT_RES = R.layout.viewpager_radiobutton;
        ...
        final void update() {
            ...
            if(this.mCustomView == null) {
                ...
                if(this.mTextView == null) {
                    TextView textView2 = (TextView)LayoutInflater.from(this.getContext()).inflate(DEFAULT_TEXT_LAYOUT_RES, this, false);
